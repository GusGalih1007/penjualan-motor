...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        $transaction = transaction::with('details.motor', 'customer', 'payment', 'users')->get();

        return view('report.index', compact('transaction', 'startDate', 'endDate'));
    }
    ...
    public function filter(Request $request)
    {
        ...
        $transaction = transaction::with('details.motor', 'customer', 'payment', 'users')
