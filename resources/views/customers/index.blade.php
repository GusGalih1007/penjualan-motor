                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Address</th>
                                <th>Member Status</th>
                                <th>Action | <a href="{{ route('customer.create') }}" class="btn btn-success btn-sm">Add</a></th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('customer.destroy', $customer->customerId) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{ route('customer.edit', $customer->customerId) }}" class="btn btn-warning btn-sm">Edit</a>
