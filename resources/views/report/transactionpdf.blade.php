    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $trans->customer->customerName ?? '-' }}</td>
                <td>Rp {{ number_format($trans->totalAmount, 0, ',', '.') }}</td>
                ...
                <td>
                    <ul>
                        ...
                        <li>{{ $detail->motor->motorName ?? 'motor tidak ditemukan' }} - Harga: Rp {{ number_format($detail->motor->price, 0, ',', '.')  }} - Jumlah: {{
                            $detail->quantity }} -
            ...
            @php $grandTotal += $trans->totalAmount; @endphp
            @endforeach
        </tbody>
        <tfoot>
            <tr>
